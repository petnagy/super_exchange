 ...
 */
class HistoryRateCompositeRepository(private val networkRepo: HistoryRateNetworkRepository, private val roomRepo: HistoryRateRoomRepository) : Repository<HistoryRate> {
