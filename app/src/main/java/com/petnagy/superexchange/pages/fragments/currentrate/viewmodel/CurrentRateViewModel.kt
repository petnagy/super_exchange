 ...
 */
class CurrentRateViewModel(private val store: Store<AppState>) : ViewModel(), LifecycleObserver {
    ...
    fun start() {
        store.dispatch(StartLocationSearchAction(fineLocationPermissionStatus.value ?: PermissionStatus.PERMISSION_DENIED))
//        loading.value = true
